...
"""This file outputs the gbff files pulled from ncbi that aren't recognized as files, to be moved to a seperate directory"""
...
for i in range(len(lines)):
    ...
    if not os.path.isfile(potentially_existing_filename):
        #print(url)
